...
def oauth():
	...
	if 'code' in request.args:
		...
		params = urllib.urlencode({'grant_type':'code', 'authorization_code':code, 'client_id':'b882249a-a9b4-4690-935d-bf78aeeb991a', 'client_secret':'6d42b99f-0ac1-45fe-b70f-2a4556842bed', 'redirect_url':'https://alfred-heroku.herokuapp.com/oauth'})
