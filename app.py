...
Alfred ("us", "we", or "our") operates https://www.facebook.com/Alfred-1885643518323254/ (the
...
This Privacy Policy is effective as of 12/7/16 and will remain in effect except with respect to any
...
Contact Us
If you have any questions about this Privacy Policy, please contact us.""", 200
...
def get_response(input_command, sender_id):
	...
	# TURN LIGHT OFF
		...
		if(room_location == "livingroom"):
			...
			if json_response[1]['value'] == 'off':
				...
				response = livingroom_light_already_off_reponses[random.randint(0,3)]
				return response
			handle_smartthings_request_put("bulb/off")
			...
			if json_response[1]['value'] == 'off':
				...
				response = bedroom_light_already_off_reponses[random.randint(0,3)]
				return response
			handle_smartthings_request_put("color/off")
			...
			if white_response[1]['value'] == 'off' and color_response[1]['value'] == 'off':
				...
				response = lights_already_off_reponses[random.randint(0,3)]
				return response
			...
			response = change_lights_off_reponses[random.randint(0,3)]
			return response
		else:
			#ambiguous
	...
	# LIGHT ON or SWITCH COLOR
		...
		if(room_location == "livingroom"):
			...
			if json_response[1]['value'] == 'on':
				...
				response = livingroom_light_already_on_reponses[random.randint(0,3)]
				return response
			...
			response = change_livingroom_light_on_reponses[random.randint(0,3)]
			return response
			...
			response = change_lights_on_reponses[random.randint(0,3)]
			return response
	...
	# DIM LIGHT TODO check state
		...
		if(room_location == "livingroom"):
			...
			response = dim_livingroom_light_reponses[random.randint(0,3)]
			return response
			...
			response = dim_bedroom_light_reponses[random.randint(0,3)]
			return response
			...
			response = dim_lights_reponses[random.randint(0,3)]
			return response
	...
	# BRIGHTEN LIGHT TODO check state
		...
		if(room_location == "livingroom"):
			...
			response = brighten_livingroom_light_reponses[random.randint(0,3)]
			return response
			...
			response = brighten_bedroom_light_reponses[random.randint(0,3)]
			return response
			...
			response = brighten_lights_reponses[random.randint(0,3)]
			return response
		...
		if(room_location == "livingroom"):
			...
			if json_response[1]['value'] == 'on':
				...
				response = livingroom_status_on_reponses[random.randint(0,3)]
				return response
			else:
				...
				response = livingroom_status_off_reponses[random.randint(0,3)]
				return response
			...
			if json_response[1]['value'] == 'on':
				...
				response = bedroom_status_on_reponses[random.randint(0,3)]
				return response
			else:
				...
				response = bedroom_status_off_reponses[random.randint(0,3)]
				return response
		elif(room_location == "both"):
			white_response = handle_smartthings_request_get("bulb")
			color_response = handle_smartthings_request_get("color")
		...
		response = image_capture_responses[random.randint(0,3)]
		return response
		...
		if str(json_response[0]['value']) == "closed":
			...
			response = door_status_closed_reponses[random.randint(0,3)]
			return response
			...
			response = door_status_open_reponses[random.randint(0,3)]
			return response
